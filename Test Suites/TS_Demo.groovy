...
def setupTestCase() {
	...
	WebUI.waitForElementClickable(findTestObject('OR_Login/textfield_username'), GlobalVariable.timeout)
	WebUI.setText(findTestObject('OR_Login/textfield_username'), 'zl@slt.com')
    WebUI.setText(findTestObject('OR_Login/textfield_password'), 'Soliton@2334')
...
def tearDownTestCase() {
	...
	//WebUI.waitForElementClickable('LogOut/Page_Welcome to Persivia/span_Latif, Zohaib_fa fa-caret-down', 0)
    ...
    WebUI.waitForElementClickable(findTestObject('OR_Login/button_Sign in'), GlobalVariable.timeout)
    WebUI.closeBrowser()
