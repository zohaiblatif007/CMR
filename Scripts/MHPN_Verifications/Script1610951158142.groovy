...
if (WebUI.verifyElementPresent(findTestObject('Object Repository/MHPN_OR/Page_Welcome to Persivia/select_MHPN'), 1, FailureHandling.STOP_ON_FAILURE)) {
    WebUI.click(findTestObject('Object Repository/MHPN_OR/Page_Welcome to Persivia/select_MHPN'))

    WebUI.click(findTestObject('MHPN_OR/Page_Welcome to Persivia/span_Hide'))

    WebUI.getUrl()

    WebUI.getText(findTestObject('Object Repository/MHPN_OR/Page_Welcome to Persivia/select_MHPN'))
}
