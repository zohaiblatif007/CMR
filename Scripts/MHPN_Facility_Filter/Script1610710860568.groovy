...
WebUI.verifyElementPresent(findTestObject('MHPN_FACILITY_FILTERS_OR/iframe_SignOut_appCCM/Page_Welcome to Persivia/td_Eligible (CCM), Suspended (Readmission)'), 
    10)
