...
WebUI.click(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Input_Search_Field/Input_Search'))

WebUI.setText(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Input_Search_Field/Input_Search'), 
    'jhon')

Type_Text = WebUI.getAttribute(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Input_Search_Field/Input_Search'), "value")
WebUI.verifyEqual(Type_Text, "jhon")

WebUI.delay(3)

WebUI.click(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Select_Filters/Select_Search'))

Thread.sleep(10000)

String Actual_Name = WebUI.getText(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Verify_Name/First and Last Name'))

WebUI.verifyEqual(Actual_Name, 'jhon, adam')

String Actual_MRN = WebUI.getText(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Verify_MRN/MRN'))

WebUI.verifyEqual(Actual_MRN, 'PE464405F7937E44AFB6996691E47674E1')

String Actual_DOB = WebUI.getText(findTestObject('Object Repository/Search By First Name_OR/Parent_Objects/Verify_DOB/DOB'))
