...
//Input "McLaren Greater Lansing - Holt Family Medicine"
WebUI.setText(findTestObject('MHPN_FACILITY_FILTERS_OR/Page_Welcome to Persivia/input_Facility_k-input'), 'McLaren Greater Lansing - Holt Family Medicine')

//select "McLaren Greater Lansing - Holt Family Medicine"
WebUI.click(findTestObject('MHPN_FACILITY_FILTERS_OR/Page_Welcome to Persivia/li_MHPN'))
...
if (WebUI.verifyElementPresent(findTestObject('MHPN_FACILITY_FILTERS_OR/Page_Welcome to Persivia/li_MHPN'), 1)) {
    ...
    //	
    if (WebUI.verifyElementPresent(findTestObject('MHPN_FACILITY_FILTERS_OR/Page_Welcome to Persivia/Page_Welcome to Persivia/Page_Welcome to Persivia/li_CCM (1)'), 
        3)) {
        WebUI.click(findTestObject('MHPN_FACILITY_FILTERS_OR/Page_Welcome to Persivia/Page_Welcome to Persivia/Page_Welcome to Persivia/li_CCM (1)'))
    } else {
        WebUI.click(findTestObject('MULTIPLE_FACILITY_FILTERS_OR/iframe_SignOut_appCCM/Page_Welcome to Persivia/Page_Welcome to Persivia/Page_Welcome to Persivia/Page_Welcome to Persivia/li_BPCI'))
    }
    
    WebUI.click(findTestObject('MHPN_FACILITY_FILTERS_OR/iframe_SignOut_appCCM/Page_Welcome to Persivia/Page_Welcome to Persivia/span_Allselect'))

    //	WebUI.click(findTestObject('MHPN_FACILITY_FILTERS_OR/Page_Welcome to Persivia/Page_Welcome to Persivia/Page_Welcome to Persivia/li_Eligible'))
    WebUI.click(findTestObject('MULTIPLE_FACILITY_FILTERS_OR/iframe_SignOut_appCCM/Page_Welcome to Persivia/Page_Welcome to Persivia/Page_Welcome to Persivia/li_Active'))
} else {
    WebUI.takeScreenshot(FailureHandling.STOP_ON_FAILURE)
}
...
//WebUI.verifyElementPresent(findTestObject('MHPN_FACILITY_FILTERS_OR/iframe_SignOut_appCCM/Page_Welcome to Persivia/td_Eligible (CCM), Suspended (Readmission)'), 10)
WebUI.verifyElementPresent(findTestObject('MULTIPLE_FACILITY_FILTERS_OR/Page_Welcome to Persivia/td_Active (CCM) (1)'), 
    10)
