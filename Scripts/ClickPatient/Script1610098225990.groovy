...
WebUI.setText(findTestObject('Object Repository/CompletePatientAdd/Page_Welcome to Persivia/input_Welcome to_username'), 
    'zl@slt.com')

WebUI.setEncryptedText(findTestObject('Object Repository/CompletePatientAdd/Page_Welcome to Persivia/input_Welcome to_userpwd'), 
    'em0u++r5ZmDZgjWgSgoa/Q==')

WebUI.click(findTestObject('Object Repository/CompletePatientAdd/Page_Welcome to Persivia/button_Sign in'))
